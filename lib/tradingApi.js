...
export const tradingApi = {
  ...
  sweep: (body) =>
    req("/backtest/sweep", { method: "POST", body: JSON.stringify(body) }),
  validate: (body) =>
    req("/backtest/validate", { method: "POST", body: JSON.stringify(body) }),
  paperOrder: (body) =>
    req("/paper/order", { method: "POST", body: JSON.stringify(body) }),
};
